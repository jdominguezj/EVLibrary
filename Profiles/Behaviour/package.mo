...
//
  ...
  model QuartM
    ...
    Modelica.Blocks.Interfaces.BooleanOutput BoolDec annotation(
      Placement(visible = true, transformation(origin = {88, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-80, 110}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
  EVLibrary.Profiles.DriveTests.Quart1 quart11 annotation(
      Placement(visible = true, transformation(origin = {-76, 68}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(quart11.y, product1.u1) annotation(
      Line(points = {{-74, 72}, {-60, 72}, {-60, 70}, {-60, 70}}, color = {0, 0, 127}));
    connect(less1.y, BoolDec) annotation(
      Line(points = {{32, -22}, {78, -22}, {78, -22}, {88, -22}}, color = {255, 0, 255}));
    connect(product1.y, derivative1.u) annotation(
      Line(points = {{-36, 64}, {-34, 64}, {-34, 16}, {-32, 16}}, color = {0, 0, 127}));
...
//
    annotation(
      Icon(graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}), Line(origin = {-39, 9}, points = {{-39, -51}, {39, 51}}, color = {255, 85, 0}, thickness = 0.75), Line(origin = {-3, 9}, points = {{-75, -51}, {75, 51}}, color = {255, 85, 255}, pattern = LinePattern.DashDotDot, thickness = 0.75)}, coordinateSystem(initialScale = 0.1)));
  end QuartM;
  ...
  model QuartM2
    ...
    Modelica.Blocks.Interfaces.BooleanOutput BoolDec annotation(
      Placement(visible = true, transformation(origin = {88, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-80, 110}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
  DriveTests.Quart2 quart21 annotation(
      Placement(visible = true, transformation(origin = {-90, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(quart21.y, product1.u1) annotation(
      Line(points = {{-88, 74}, {-66, 74}, {-66, 70}, {-60, 70}, {-60, 70}}, color = {0, 0, 127}));
    connect(less1.y, BoolDec) annotation(
      Line(points = {{32, -22}, {78, -22}, {78, -22}, {88, -22}}, color = {255, 0, 255}));
    connect(product1.y, derivative1.u) annotation(
      Line(points = {{-36, 64}, {-34, 64}, {-34, 16}, {-32, 16}}, color = {0, 0, 127}));
...
//
  ...
  model QuartM3
    ...
    Modelica.Blocks.Interfaces.BooleanOutput BoolDec annotation(
      Placement(visible = true, transformation(origin = {88, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-80, 110}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
  DriveTests.Quart3 quart31 annotation(
      Placement(visible = true, transformation(origin = {-106, 70}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(quart31.y, product1.u1) annotation(
      Line(points = {{-104, 74}, {-60, 74}, {-60, 70}, {-60, 70}}, color = {0, 0, 127}));
    connect(less1.y, BoolDec) annotation(
      Line(points = {{32, -22}, {78, -22}, {78, -22}, {88, -22}}, color = {255, 0, 255}));
    connect(product1.y, derivative1.u) annotation(
      Line(points = {{-36, 64}, {-34, 64}, {-34, 16}, {-32, 16}}, color = {0, 0, 127}));
...
//
  ...
  model QuartM4
    ...
    Modelica.Blocks.Interfaces.BooleanOutput BoolDec annotation(
      Placement(visible = true, transformation(origin = {88, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-80, 110}, extent = {{10, -10}, {-10, 10}}, rotation = -90)));
  DriveTests.Quart4 quart41 annotation(
      Placement(visible = true, transformation(origin = {-106, 58}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    connect(quart41.y, product1.u1) annotation(
      Line(points = {{-104, 62}, {-70, 62}, {-70, 70}, {-60, 70}, {-60, 70}, {-60, 70}}, color = {0, 0, 127}));
    connect(less1.y, BoolDec) annotation(
      Line(points = {{32, -22}, {78, -22}, {78, -22}, {88, -22}}, color = {255, 0, 255}));
    connect(product1.y, derivative1.u) annotation(
      Line(points = {{-36, 64}, {-34, 64}, {-34, 16}, {-32, 16}}, color = {0, 0, 127}));
