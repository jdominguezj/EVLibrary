...
parameter Real Np;
 ...
 extends Modelica.Electrical.Analog.Interfaces.TwoPin;
  ...
  Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C = 0.85*3600 * capacity) annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput Irb annotation(
    Placement(visible = true, transformation(origin = {-42, -92}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {0, -120}, extent = {{20, -20}, {-20, 20}}, rotation = -90)));
  Modelica.Blocks.Math.Feedback feedback1 annotation(
    Placement(visible = true, transformation(origin = {4, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 90)));
  Modelica.Blocks.Math.Abs abs1 annotation(
    Placement(visible = true, transformation(origin = {34, 6}, extent = {{-6, -6}, {6, 6}}, rotation = 90)));
 ...
 Modelica.Blocks.Interfaces.BooleanInput Accel annotation(
    Placement(visible = true, transformation(origin = {-76, -2}, extent = {{-12, -12}, {12, 12}}, rotation = 0), iconTransformation(origin = {0, 120}, extent = {{-20, -20}, {20, 20}}, rotation = 90)));
equation
  connect(np.y, signalCurrent1.i) annotation(
    Line(points = {{56, 26}, {56, -38}, {21, -38}}, color = {0, 0, 127}));
  connect(currentSensor1.i, np.u) annotation(
  ...
  connect(idealCommutingSwitch.n2, signalCurrent2.n) annotation(
    Line(points = {{-42, -24}, {-18, -24}, {-18, -28}, {-18, -28}}, color = {0, 0, 255}));
  connect(idealCommutingSwitch.n1, signalCurrent1.p) annotation(
    Line(points = {{-42, -19}, {14, -19}, {14, -28}}, color = {0, 0, 255}));
  connect(idealCommutingSwitch.p, capacitor1.p) annotation(
    Line(points = {{-62, -24}, {-67, -24}, {-67, -24}, {-72, -24}, {-72, -29}, {-72, -29}, {-72, -34}}, color = {0, 0, 255}));
  connect(capacitor1.n, n) annotation(
    Line(points = {{-72, -54}, {-72, -64}, {100, -64}, {100, 0}}, color = {0, 0, 255}));
  connect(resistor1.p, capacitor1.p) annotation(
    Line(points = {{-92, -34}, {-92, -34}, {-92, -24}, {-72, -24}, {-72, -34}, {-72, -34}}, color = {0, 0, 255}));
  connect(resistor1.n, capacitor1.n) annotation(
    Line(points = {{-92, -54}, {-92, -54}, {-92, -54}, {-92, -54}, {-92, -64}, {-72, -64}, {-72, -54}, {-72, -54}}, color = {0, 0, 255}));
  connect(signalCurrent1.n, capacitor1.n) annotation(
    Line(points = {{14, -48}, {14, -64}, {-72, -64}, {-72, -54}}, color = {0, 0, 255}));
  connect(Irb, signalCurrent2.i) annotation(
    Line(points = {{-42, -92}, {-8, -92}, {-8, -38}, {-11, -38}}, color = {0, 0, 127}));
  connect(signalCurrent2.p, n) annotation(
    Line(points = {{-18, -48}, {-18, -64}, {100, -64}, {100, 0}}, color = {0, 0, 255}));
  connect(vpack.v, product2.u1) annotation(
    Line(points = {{94, 52}, {106, 52}, {106, 86}, {148, 86}, {148, 84}}, color = {0, 0, 127}));
  connect(vpack.n, n) annotation(
    Line(points = {{84, 42}, {86, 42}, {86, 0}, {100, 0}, {100, 0}}, color = {0, 0, 255}));
  connect(rTransL1.n, vpack.p) annotation(
    Line(points = {{24, 80}, {34, 80}, {34, 62}, {84, 62}, {84, 62}}, color = {0, 0, 255}));
  connect(ns.y, product2.u2) annotation(
    Line(points = {{131, 54}, {139, 54}, {139, 72}, {147, 72}, {147, 72}, {147, 72}, {147, 72}}, color = {0, 0, 127}));
