...
//Charge capacity =3600⋅Capacity⋅ f1(Cycle)⋅ f2(Temp)  Taken from: An Accurate Electrical Battery Model Capable of Predicting Runtime and I–V Performance
 ...
 extends Modelica.Electrical.Analog.Interfaces.TwoPin;
  ...
  Modelica.Electrical.Analog.Basic.Capacitor capacitor1(C = 3600 * 162)  annotation(
  ...
  Modelica.Blocks.Interfaces.RealInput Irb annotation(
    Placement(visible = true, transformation(origin = {-36, -100}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {0, -120}, extent = {{20, -20}, {-20, 20}}, rotation = -90)));
...
equation
  connect(Irb, signalCurrent2.i) annotation(
    Line(points = {{-36, -100}, {-8, -100}, {-8, -38}, {-12, -38}}, color = {0, 0, 127}));
