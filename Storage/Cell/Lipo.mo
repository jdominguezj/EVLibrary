...
model Lipo
  ...
  Modelica.Blocks.Interfaces.RealInput Irb annotation(
    Placement(visible = true, transformation(origin = {-36, -100}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-120, 0}, extent = {{20, -20}, {-20, 20}}, rotation = 180)));
  ...
  Modelica.Electrical.Analog.Interfaces.Pin pin annotation(
    Placement(visible = true, transformation(origin = {-92, 32}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, 110}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Modelica.Electrical.Analog.Basic.Ground ground2 annotation(
    Placement(visible = true, transformation(origin = {14, -80}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(currentSensor1.n, pin) annotation(
    Line(points = {{64, 80}, {76, 80}, {76, 98}, {-92, 98}, {-92, 32}, {-92, 32}}, color = {0, 0, 255}));
