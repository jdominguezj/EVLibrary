...
model Test_NEDC_CR2
  ...
  EVLibrary.Braking.RegBrake2 regBrake2(Mav = Bolt2.Mv, Rw = Bolt2.Rw, vel = nEDCCycle.Vel) annotation(
    Placement(visible = true, transformation(origin = {76, -66}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
equation
  connect(lipo2.Irb, regBrake2.Irb) annotation(
    Line(points = {{76, -36}, {76, -36}, {76, -54}, {76, -54}}, color = {0, 0, 127}));
  connect(regBrake2.n, lipo2.n) annotation(
    Line(points = {{86, -66}, {86, -66}, {86, -24}, {86, -24}}, color = {0, 0, 255}));
  connect(regBrake2.p, lipo2.p) annotation(
  ...
  regBrake2.a = nEDCCycle.Accel;
  regBrake2.BoolDec = nEDCCycle.BoolDec;
